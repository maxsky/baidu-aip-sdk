...
class AipImageClassify extends AipBase {
     ...
     * @return array
     */
    public function flower($image, $options = []) {
     ...
     * @return array
     */
    public function ingredient($image, $options = []) {
     ...
     * @return array
     */
    public function redwine($image, $options = []) {
     ...
     * @return array
     */
    public function currency($image, $options = []) {
